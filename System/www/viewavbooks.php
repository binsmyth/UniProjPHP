...
<?php
	...
	$a = $b->viewallbook($_SESSION['email'],$_SESSION['postcode']);
	echo "<table border=\"1\">";
	...
	if($a)
	{
		...
		{		
			...
			echo "</td>";
			echo "<td>";
			echo "<a href=\"viewavbooks.php?borrow={$row['book_id']}\">Borrow</a>";
			echo "</td>";
			echo "</tr>";
		}
	}
...
else
{
	...
	$rows = $r->borrowbook($book,$_SESSION['user_id']);
	if($rows>0)
	{
		header("Location:viewavbooks.php");
	}
	else
	{
